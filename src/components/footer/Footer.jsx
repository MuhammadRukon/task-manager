...
const Footer = () => {
  return (
    <>
      <Container>
        <footer className="text-center text-[14px] mt-[79px] lg:grid-cols-6 justify-between">
          {/* first column */}
          <div className="mb-12 lg:mb-0 flex flex-col">
            <Link to={"/"} className="text-base font-bold ">
              <p className="font-integralCf  font-bold text-2xl">Task</p>
            </Link>
            <p className="w-[90%] mx-auto my-[24px]">
              Fast growing task management web application to maintain your day
              to day tasks. Continuously trying to integrate more feature to
              please the users.
            </p>
            {/* social icons */}
      ...
      <p className="text-center text-sm border-t-[1px] py-[15px] border-[#EFEFEF] text-[#A4A4A4]">
        Copyright © 2023 Muhammad Sheikh Rukon
      </p>
    </>
  );
};
